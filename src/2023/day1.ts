...
export const puzzleInput = `heightseven4two5
npskfdstpk2knsm
...
// console.log(findSum(puzzleInput));
...
export const part2PuzzleInput = `heightseven4two5
npskfdstpk2knsm
djnrmpxjbsbpgzvtjkhq6pkkfshx
kgsddxsevensevenlcmkdlcgtfbqxmlnkhbnvhshkckppn2
8blvspztqjnine854fivefour
...
console.log(findSum2(part2Example));
